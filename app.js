...
// üst taraftaki kod sözlük database'i ile ilgilidir.
...
const behind = document.getElementsByClassName("behind")[0];
let isTurned = false;
main.addEventListener("click", () => {
    if (isTurned) {
        ...
        behind.style.transform = "rotateY(360deg)";
        isTurned = !isTurned;
...
nextButton.addEventListener("click", () => {
    ...
    behind.style.transform = "rotateY(270deg)";
